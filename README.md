...
### MapMyIndia — Software Engineer
Java · Spring Boot · Angular · Microservices

- Improved API performance by ~35%  
- Built scalable backend services with PostgreSQL and MongoDB  
- Fixed concurrency and memory issues  
- Supported Angular-based applications with robust APIs  
